...
@export var bg_color : Color = Color.GOLD
@export var to_scene : PackedScene = null
@export var title_color := Color.RED
@export var text_color := Color.BLUE
...
var credits = [
	[
		"A game by SGME, Ezra Goswami owns SGME"
	],[
		"Programming",
		"Owner(Ezra Goswami)"
		...
		"Testers",
		"Owner(Ezra Goswami)",
		"Owner's brother(Joshua Goswami)"
	],[
		"Tools used",
		"Developed with Godot Engine",
		"https://godotengine.org/license",
		"",
		"Art created with Piskelapp",
		...
		"Special thanks",
		"Owner(Ezra Goswami)",
		"The one who gave me the idea(Arunasri Goswami)",
		"Owner's brother(Joshua Goswami)"
	]
]
